...
export const LandScape = () => {
	...
	const initialPage = parseInt(localStorage.getItem('currentPageC')) || 0;

	const [currentPageC, setCurrentPageC] = useState(initialPage);
	...
	return (
		<div className=" w-full">
			...
			<div className="flex justify-around text-3xl text-white py-3 bg-black" >
				...
				>  Anterior </button>
				<p>Pag {currentPageC + 1} de {Math.ceil((store.category_pictures.length) / 12)}</p>
